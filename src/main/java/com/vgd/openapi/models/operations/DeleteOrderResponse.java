...
public class DeleteOrderResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteOrderResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Order deleted
     */
    public DeleteOrderResponse withOrder(Order order) {
        Utils.checkNotNull(order, "order");
     ...
     * Order deleted
     */
    public DeleteOrderResponse withOrder(Optional<? extends Order> order) {
        Utils.checkNotNull(order, "order");
        this.order = order;
        return this;
    }
