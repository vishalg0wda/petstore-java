...
public class PlaceOrderResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PlaceOrderResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * successful operation
     */
    public PlaceOrderResponse withOrder(Order order) {
        Utils.checkNotNull(order, "order");
     ...
     * successful operation
     */
    public PlaceOrderResponse withOrder(Optional<? extends Order> order) {
        Utils.checkNotNull(order, "order");
        this.order = order;
        return this;
    }
